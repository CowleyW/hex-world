...
impl Renderer {
    ...
    pub async fn new(window: Window) -> Self {
        ...
        let texture = Texture::from_bytes(&device, &queue, include_bytes!("../../assets/textures/OBSKLD0.jpg"), "texture").unwrap();
        ...
        let instances = (0..10).flat_map(|z| {
            (0..10).map(move |x| {
                let position = cgmath::Vector3 { x: (x + 1) as f32, y: 0.0, z: (z + 1) as f32 };
